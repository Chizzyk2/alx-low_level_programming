...
/**
 * _atoi_digit - conversion from character to integer
 * @x: character
 * Return:Is int
 **/
...
/**
 *_calloc - array memory call
 * @nmemb: elements numbering
 * @size: size
 * Return: ptr
 **/
...
/**
 * mul_array - array multiplication
 * @a1: array foremost call
 * @len1: array length
 * @a2:  array character
 * @a3: result
 * @lena: length
